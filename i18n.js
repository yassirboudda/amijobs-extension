...
const AMIJOBS_I18N = {
  fr: {
    ...
    locationsHint: "Une ville/région par ligne — suggestions Indeed (ex: Île-de-France)",
  ...
  en: {
    ...
    locationsHint: "One city/region per line — Indeed suggestions (e.g. Île-de-France)",
  ...
  es: {
    ...
    locationsHint: "Una ciudad/región por línea — sugerencias Indeed (ej.: Île-de-France)",
