...
const AMIJOBS_I18N = {
  fr: {
    ...
    locationsHint: "International — une ville/région par ligne (ex: Zaventem, Poznań, London). Indeed & Glassdoor suivent le pays.",
  ...
  en: {
    ...
    locationsHint: "Worldwide — one city/region per line (e.g. Zaventem, Poznań, London). Indeed & Glassdoor follow the country.",
  ...
  es: {
    ...
    locationsHint: "Internacional — una ciudad/región por línea (ej.: Zaventem, Poznań, London). Indeed y Glassdoor siguen el país.",
